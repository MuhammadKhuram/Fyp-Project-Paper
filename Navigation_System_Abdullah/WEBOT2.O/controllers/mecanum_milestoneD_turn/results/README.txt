After a full 28/28 run, this folder will contain:
  ...
  row_switch_log_turn.csv      (columns: mode, switch_index, start_time_s, end_time_s, switch_time_s, energy_estimate)

row_switch_log_turn.csv is one of the two files plot_row_switch.py reads.
