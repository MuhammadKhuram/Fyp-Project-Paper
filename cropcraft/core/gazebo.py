...
class GazeboModel:
    ...
    def export_object(self, name: str, object: bpy.types.Object):
        ...
        if object.active_material and object.active_material.node_tree:
            for node in object.active_material.node_tree.nodes:
                if node.type == 'TEX_IMAGE' and node.image:
                    image = node.image
                    dest_name = os.path.basename(image.filepath) or (image.name + '.jpg')
                    dest = os.path.join(self.meshes_path, dest_name)
